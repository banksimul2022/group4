...
QT_MOC_LITERAL(1, 14, 4), // "RFID"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "DLLSerialPort\0RFID\0"
};
...
void DLLSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RFID((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DLLSerialPort::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLSerialPort::RFID)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DLLSerialPort::RFID(QByteArray _t1)
{
